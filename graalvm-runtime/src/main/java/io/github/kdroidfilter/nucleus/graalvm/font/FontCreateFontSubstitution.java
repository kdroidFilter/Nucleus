 ...
 * <p>
 * In GraalVM native image on Windows and Linux, classpath resource InputStreams may not work
 ...
 */
@TargetClass(value = java.awt.Font.class, onlyWith = IsWindowsOrLinux.class)
