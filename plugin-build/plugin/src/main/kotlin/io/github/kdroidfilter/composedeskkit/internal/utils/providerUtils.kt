...
internal inline fun <reified T : Any> ObjectFactory.new(vararg params: Any): T = newInstance(T::class.java, *params)

internal inline fun <reified T : Any> ObjectFactory.nullableProperty(): Property<T> = property(T::class.java)
...
internal inline fun <reified T : Any> Task.provider(noinline fn: () -> T): Provider<T> = project.provider(fn)

internal fun ProviderFactory.valueOrNull(prop: String): Provider<String> = gradleProperty(prop)
